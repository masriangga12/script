...
# install webmin
cd
wget "script.fawzya.net/debian/webmin.deb"
...
# sett permission
mv /root/baru /usr/bin/baru
chmod +x /usr/bin/baru
mv /root/user /usr/bin/user
chmod +x /usr/bin/user
chmod +x on
mv /root/perpanjang /usr/bin/perpanjang
chmod +x /usr/bin/perpanjang
mv /root/del /usr/bin/del
chmod +x /usr/bin/del
mv /root/userexp /usr/bin/userexp
chmod +x /usr/bin/userexp
mv /root/menu /usr/bin/menu
